...
void (function (global) {
  ...
  L.tileLayer
    .main("layers_osrs/mapsquares/-1/{zoom}/{plane}_{x}_{y}.png", {
      minZoom: -4,
      maxNativeZoom: 4,
      maxZoom: 8,
    })
  ...
  let nomove = L.tileLayer.main(
    "layers_osrs/nomove/-1/{zoom}/{plane}_{x}_{y}.png",
    {
      minZoom: -4,
      maxNativeZoom: 2,
      maxZoom: 8,
  ...
  let objects = L.tileLayer.main(
    "layers_osrs/locations/-1/{zoom}/{plane}_{x}_{y}.png",
    {
      minZoom: -4,
      maxNativeZoom: 2,
      maxZoom: 8,
  ...
  let multimap = L.tileLayer.main(
    "layers_osrs/multimap/-1/{zoom}/{plane}_{x}_{y}.png",
    {
      minZoom: -4,
      maxNativeZoom: 2,
      maxZoom: 8,
  ...
  let implings = L.tileLayer.main(
    "layers_osrs/implings/-1/{zoom}/{plane}_{x}_{y}.png",
    {
      minZoom: -4,
      maxNativeZoom: 2,
      maxZoom: 8,
